...
Option setzen, die nur zur Compile-Zeit verfügbar ist (siehe [Kapitel 14](compile-zeit.md)). Dann
...
sondern in einer eigenen `settings-override.h` (siehe [Kapitel 14](compile-zeit.md)). So überschreibt
